...
export const CLASS_DETAIL = {
  ...
  BADGE_CLASS_COMPLETED: 'Đã hoàn thành',
  BADGE_CLASS_CERTIFICATE: 'Chứng chỉ',
};
...
export const COURSE_DETAIL = {
  ...
  SECTION_FORUM: 'Diễn đàn khóa học',
  FORUM_LEAD:
    'Mọi người đều có thể xem và đăng bài; bình luận trong bài chỉ trong cửa sổ chi tiết. Chưa đăng nhập thì nhập nickname khi gửi. Bấm một bài để xem bình luận và phản hồi.',
  FORUM_DETAIL_TITLE: 'Chi tiết bài viết',
  FORUM_OPEN_DETAIL: 'Mở bài viết',
  FORUM_COMMENT_COUNT: '{n} bình luận',
  FORUM_CLOSE: 'Đóng',
  FORUM_LIST_HINT: 'Bấm vào bài để xem đầy đủ và bình luận.',
  FORUM_WRITE_COMMENT: 'Viết bình luận',
  FORUM_ALL_COMMENTS: 'Tất cả bình luận',
  FORUM_NO_COMMENTS: 'Chưa có bình luận.',
  FORUM_GUEST_NAME: 'Nickname của bạn',
  FORUM_NICKNAME_DIALOG_TITLE: 'Cần có nickname',
  FORUM_NICKNAME_DIALOG_LEAD:
    'Bạn chưa đăng nhập. Hãy nhập nickname (2–80 ký tự) để tiếp tục đăng bài hoặc bình luận.',
  FORUM_NICKNAME_TOO_SHORT: 'Nickname quá ngắn (tối thiểu 2 ký tự).',
  FORUM_NICKNAME_TOO_LONG: 'Nickname quá dài (tối đa 80 ký tự).',
  FORUM_NICKNAME_CONFIRM: 'Tiếp tục',
  FORUM_POST_PLACEHOLDER: 'Viết bài thảo luận...',
  FORUM_COMMENT_PLACEHOLDER: 'Viết bình luận...',
  FORUM_REPLY_PLACEHOLDER: 'Viết phản hồi...',
  FORUM_POST_BTN: 'Đăng bài',
  FORUM_COMMENT_BTN: 'Bình luận',
  FORUM_REPLY_BTN: 'Trả lời',
  FORUM_CANCEL_REPLY: 'Hủy trả lời',
  FORUM_EMPTY: 'Chưa có bài viết nào. Hãy mở đầu cuộc thảo luận.',
  FORUM_DELETED: 'Nội dung đã bị xóa.',
  FORUM_LOAD_ERR: 'Không tải được diễn đàn.',
  FORUM_SEND_ERR: 'Không gửi được nội dung. Vui lòng thử lại.',
  FORUM_POSTED_OK: 'Đã đăng bài.',
  FORUM_COMMENTED_OK: 'Đã gửi bình luận.',
  FORUM_EDIT: 'Sửa',
  FORUM_DELETE: 'Xóa',
};
...
export const LECTURE_DETAIL = {
  ...
  MARK_COMPLETE: 'Đánh dấu đã học xong',
  LECTURE_COMPLETED: 'Đã học xong bài này',
  COMPLETE_ERROR: 'Không lưu được tiến độ. Vui lòng thử lại.',
};
...
export const DASH_STUDENT = {
  ...
  CLASS_CERT_BADGE: 'Chứng chỉ',
  REFUND_BTN: 'Yêu cầu hoàn tiền',
  REFUND_PENDING_BADGE: 'Chờ duyệt hoàn tiền',
  REFUND_MEMBERSHIP_REFUNDED: 'Đã hoàn tiền',
  REFUND_LAST_REJECTED: 'Yêu cầu hoàn tiền trước đó đã bị từ chối.',
  REFUND_DIALOG_TITLE: 'Gửi yêu cầu hoàn tiền',
  REFUND_DIALOG_LEAD:
    'Yêu cầu của bạn được gửi đến quản trị viên để duyệt thủ công. Trong lúc chờ, bạn vẫn có thể học lớp này.',
  REFUND_REASON_LABEL: 'Lý do hoàn tiền',
  REFUND_REASON_HELPER: 'Ít nhất 10 ký tự, tối đa 4000 ký tự.',
  REFUND_SEND: 'Gửi',
  REFUND_SENT: 'Đã gửi yêu cầu hoàn tiền.',
  REFUND_ERR_SHORT: 'Lý do quá ngắn.',
  REFUND_ERR_LONG: 'Lý do quá dài.',
  REFUND_ERR_PENDING: 'Bạn đã có yêu cầu hoàn tiền đang chờ xử lý.',
  REFUND_ERR_GENERIC: 'Không gửi được yêu cầu. Vui lòng thử lại.',
  ...
  TAB_CERTIFICATES: 'Quản lý chứng chỉ',
  CERT_SECTION_TITLE: 'Quản lý chứng chỉ',
  CERT_SECTION_SUB:
    'Chứng chỉ PDF khi đã xem đủ bài giảng, đạt trắc nghiệm (≥70% mỗi bài) và — nếu học qua lớp — mọi buổi trong lịch đã kết thúc.',
  CERT_TH_SCOPE: 'Phạm vi / Khóa',
  CERT_TH_LECTURES: 'Bài giảng',
  CERT_TH_QUIZZES: 'Trắc nghiệm',
  CERT_TH_SCHEDULE: 'Lịch học',
  CERT_TH_STATUS: 'Trạng thái',
  CERT_TH_ACTION: 'Hành động',
  CERT_KIND_COURSE: 'Ghi danh khóa',
  CERT_KIND_CLASS: 'Lớp',
  CERT_SCHEDULE_NA: 'Không áp dụng',
  CERT_SCHEDULE_OK: 'Đã xong',
  CERT_SCHEDULE_WAIT: 'Chưa đủ buổi',
  CERT_SCHEDULE_EMPTY: 'Chưa có buổi',
  CERT_STATUS_ELIGIBLE: 'Đủ điều kiện',
  CERT_STATUS_PENDING: 'Chưa đủ điều kiện',
  CERT_DOWNLOAD: 'Tải PDF',
  CERT_EMPTY: 'Bạn chưa có khóa ghi danh hoặc lớp nào để hiển thị chứng chỉ.',
  CERT_LOAD_ERROR: 'Không tải được trạng thái chứng chỉ.',
  CERT_DOWNLOAD_ERR: 'Không tải được tệp chứng chỉ.',
};
...
export const DASH_ADMIN = {
  ...
  PAYMENTS_SUB_REFUNDS: 'Hoàn tiền lớp',
  ...
  PAYMENTS_STATUS_REFUNDED: 'Đã hoàn tiền',
  ...
  PAYMENTS_REFUND_TH_REASON: 'Lý do học viên',
  PAYMENTS_REFUND_TH_REQUEST_DATE: 'Ngày gửi',
  PAYMENTS_REFUND_APPROVE: 'Duyệt hoàn tiền',
  PAYMENTS_REFUND_REJECT: 'Từ chối yêu cầu',
  PAYMENTS_REFUND_TOAST: 'Đã xử lý yêu cầu hoàn tiền.',
  PAYMENTS_REFUND_EMPTY: 'Không có yêu cầu hoàn tiền.',
